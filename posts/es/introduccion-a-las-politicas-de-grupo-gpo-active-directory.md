...
![Editor de políticas de grupo local gpedit.msc en Windows](./images/2026-01-04_21-29.png)
...
![Consola de administración de políticas de grupo Group Policy Management en Active Directory](./images/image-1.png)

![Editor de objetos de políticas de grupo Group Policy Editor en Active Directory](images/image.png)
...
![GUID de una GPO mostrado en sus propiedades](images/image-17.png)
...
![Vista de objetos GPC desde la consola Active Directory Users and Computers](images/image-12.png)
...
![Estructura de carpetas de GPO almacenadas en SYSVOL](images/image-16.png)
...
![Subcarpetas Machine y User dentro de la estructura GPT en SYSVOL](images/image-14.png)
...
![Contenido del archivo GPT.INI mostrando el número de versión de la GPO](images/image-15.png)
...
![Atributos del objeto GPC visualizados en Active Directory](images/image-13.png)
