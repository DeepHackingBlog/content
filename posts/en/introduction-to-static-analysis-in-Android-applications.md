...
![Folder and file structure generated by Apktool after decompiling the APK](../es/images/image-1.png)
...
![Main Jadx-gui window just opened, with no application loaded](../es/images/image-2.png)
...
![Class and package tree of an APK loaded in Jadx-gui](../es/images/image-3.png)

If we select a file, a tab will open where we can view and analyze it:

![Decompiled Java code of a class shown in a Jadx-gui tab](../es/images/image-4.png)
...
![Jadx-gui text search showing matches inside the application's code](../es/images/image-5.png)
...
![Console showing the MobSF web server starting up on port 8000](../es/images/image-6.png)

The default username and password are `mobsf` in both cases:

![Login screen of the MobSF web interface](../es/images/image-7.png)
...
![Static analysis report generated by MobSF for an Android application](../es/images/image-8.png)
