...
![Running the apktool d command to decompile an Android application](../es/images/image.png)

![Folder and file structure generated by Apktool after decompiling the APK](../es/images/image%201.png)
...
![Main Jadx-gui window just opened, with no application loaded](../es/images/image%202.png)
...
![Class and package tree of an APK loaded in Jadx-gui](../es/images/image%203.png)

If we select a file, a tab will open where we can view and analyze it:

![Decompiled Java code of a class shown in a Jadx-gui tab](../es/images/image%204.png)
...
![Jadx-gui text search showing matches inside the application's code](../es/images/image%205.png)
...
![Console showing the MobSF web server starting up on port 8000](../es/images/image%206.png)

The default username and password are `mobsf` in both cases:

![Login screen of the MobSF web interface](../es/images/image%207.png)
...
![Static analysis report generated by MobSF for an Android application](../es/images/image%208.png)
