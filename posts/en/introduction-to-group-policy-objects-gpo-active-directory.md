...
![Local Group Policy Editor gpedit.msc in Windows](./images/2026-01-04_21-29.png)
...
![Group Policy Management Console in Active Directory](./images/image-1.png)

![Group Policy Editor for policy objects in Active Directory](images/image.png)
...
![GUID of a GPO shown in its properties](images/image-17.png)
...
![View of GPC objects from the Active Directory Users and Computers console](images/image-12.png)
...
![Folder structure of GPOs stored in SYSVOL](images/image-16.png)
...
![Machine and User subfolders within the GPT structure in SYSVOL](images/image-14.png)
...
![Content of GPT.INI file showing the GPO version number](images/image-15.png)
...
![Attributes of the GPC object visualized in Active Directory](images/image-13.png)
