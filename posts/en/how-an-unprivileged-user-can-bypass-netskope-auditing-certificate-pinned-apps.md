...
![Netskope bypass proof of concept: blocked request with wget (403 Forbidden) versus successful request with the binary renamed to ms-teams.exe (301 Moved Permanently)](https://cdn.deephacking.tech/i/posts/como-un-usuario-sin-privilegios-puede-saltarse-netskope-auditando-certificate-pinned-apps/como-un-usuario-sin-privilegios-puede-saltarse-netskope-auditando-certificate-pinned-apps-1.avif)
